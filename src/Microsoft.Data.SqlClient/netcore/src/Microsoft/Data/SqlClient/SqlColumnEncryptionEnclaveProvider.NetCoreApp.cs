...
namespace PwC.Data.SqlClient
{
    ...
    public abstract partial class SqlColumnEncryptionEnclaveProvider
    {
        ...
        public abstract void CreateEnclaveSession(byte[] enclaveAttestationInfo, ECDiffieHellmanCng clientDiffieHellmanKey, string attestationUrl, string servername,
